...
var PathDemoPing = "/github.com.SuKaiFei.fantastic_happiness.service.v1.Demo/Ping"
...
func RegisterDemoBMServer(e *bm.Engine, server DemoBMServer) {
	DemoSvc = server
	e.GET("/github.com.SuKaiFei.fantastic_happiness.service.v1.Demo/Ping", demoPing)
}
